; copied directly from MuddyPuddlesImpoppable. only tested with double cash. variations needed for standard play
MuddyPuddlesAlternate() {
    ...
    Place("Sniper D", true)
    Upgrade("Sniper D", 1, 1, 0, true)      ; 000 -> 110
